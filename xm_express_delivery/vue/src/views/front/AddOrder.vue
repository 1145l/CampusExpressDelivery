<template>
  <div class="card" style="width: 50%; margin: 10px auto">
    <div style="font-size: 20px; margin: 20px 0; text-align: center; position: relative">
      发布代取订单
      <el-button plain type="primary" style="position: absolute; right: 20px" @click="viewAddress" :disabled="data.user.role === 'COURIER'">地址簿</el-button>
    </div>
    <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="120px" style="padding: 20px">
      ...
      <div style="text-align: center">
        <el-button type="primary" style="padding: 20px 30px" @click="addOrder" :disabled="data.user.role === 'COURIER'">发 布</el-button>
      </div>
    </el-form>
